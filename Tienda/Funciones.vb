Public Class Funciones
    ...
    Public Shared Function DecimalLetras(ByVal numero As String) As String
        ...
        If Val(numero) <= 999999999 Then
                ...
                Select Case y
                    ...
                    Case 1, 4, 7
                        ...
                        Select Case Mid(entero, num, 1)
                            ...
                            Case "7"
                                If flag = "N" Then palabras = palabras & "SIENTE "
                            Case "8"
            ...
            If dec <> String.Empty Then
                DecimalLetras = palabras & "Y " & CStr(CInt(dec)) & "/100"
            Else
